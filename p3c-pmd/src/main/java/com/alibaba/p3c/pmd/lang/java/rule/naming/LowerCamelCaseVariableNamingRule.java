...
public class LowerCamelCaseVariableNamingRule extends AbstractAliRule {
    ...
    private Pattern pattern = Pattern.compile("^[a-z][a-z0-9]*([A-Z][a-z0-9]+)*(DO|DTO|VO|DAO|BO|DOList|DTOList|VOList|DAOList|BOList|X|Y|Z|UDF|UDAF|[A-Z]|AO|AOList|ES|MQ)?$");
